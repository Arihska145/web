...
try {
    ...
    $dbartis = new artistDB($pdo);
    $row = $dbartis->findById($default);
    
    $dbgenre = new GenreDB($pdo);
    $genres = $dbgenre->findForartist($default);  
    
    $dbsubject = new SubjectDB($pdo);
    $subjects = $dbsubject->findForartist($default);    
    
    $dbreview = new ReviewDB($pdo);
    $reviews= $dbreview->findForartist($default);   
    $averageRatt = round($dbreview->AverageForartist($default)); 
...
<main >
    <!-- Main section about artist -->
    <section class="ui segment grey100">
        <div class="ui doublt stackable grid container">
            ...
            <div class="seven wide column">
                ...
                <div class="item">
                    ...
                    <h3 ><?php echo utf8_encode($row['FirstName'] . ' ' . $row['LastName']); ?></h3>
                      <div class="meta">
                        <p><?php echo generateRattStars($averageRatt); ?></p>
    ...
    <?php include 'includes/artist-large-tabs.inc.php'; ?> 
